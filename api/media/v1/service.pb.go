...
const file_media_v1_service_proto_rawDesc = "" +
	"\n" +
	"\x16media/v1/service.proto\x12\bmedia.v1\x1a\x14media/v1/media.proto2\xf1\t\n" +
	"\fMediaService\x12Y\n" +
	...
	"\x13CreateNewCollection\x12$.media.v1.CreateNewCollectionRequest\x1a%.media.v1.CreateNewCollectionResponse\x12P\n" +
	"\rGetAssetsPage\x12\x1e.media.v1.GetAssetsPageRequest\x1a\x1f.media.v1.GetAssetsPageResponseB7Z5github.com/lucas-woo/cloud-drive/api/media/v1/mediav1b\x06proto3"
...
var file_media_v1_service_proto_goTypes = []any{
	...
	(*GetAssetsPageRequest)(nil),             // 13: media.v1.GetAssetsPageRequest
	(*CreateNewProjectResponse)(nil),         // 14: media.v1.CreateNewProjectResponse
	(*UploadObjectResponse)(nil),             // 15: media.v1.UploadObjectResponse
	(*UploadImageApiResponse)(nil),           // 16: media.v1.UploadImageApiResponse
	(*UploadFileApiResponse)(nil),            // 17: media.v1.UploadFileApiResponse
	(*ObjectUploadConfirmationResponse)(nil), // 18: media.v1.ObjectUploadConfirmationResponse
	(*GetDashboardResponse)(nil),             // 19: media.v1.GetDashboardResponse
	(*GetAssetsResponse)(nil),                // 20: media.v1.GetAssetsResponse
	(*GetAllFoldersResponse)(nil),            // 21: media.v1.GetAllFoldersResponse
	(*GetAllCollectionsResponse)(nil),        // 22: media.v1.GetAllCollectionsResponse
	(*GetAssetsInFolderResponse)(nil),        // 23: media.v1.GetAssetsInFolderResponse
	(*GetAssetsInCollectionResponse)(nil),    // 24: media.v1.GetAssetsInCollectionResponse
	(*CreateNewFolderResponse)(nil),          // 25: media.v1.CreateNewFolderResponse
	(*CreateNewCollectionResponse)(nil),      // 26: media.v1.CreateNewCollectionResponse
	(*GetAssetsPageResponse)(nil),            // 27: media.v1.GetAssetsPageResponse
}
var file_media_v1_service_proto_depIdxs = []int32{
	...
	13, // 13: media.v1.MediaService.GetAssetsPage:input_type -> media.v1.GetAssetsPageRequest
	14, // 14: media.v1.MediaService.CreateNewProject:output_type -> media.v1.CreateNewProjectResponse
	15, // 15: media.v1.MediaService.UploadObject:output_type -> media.v1.UploadObjectResponse
	16, // 16: media.v1.MediaService.UploadImageApi:output_type -> media.v1.UploadImageApiResponse
	17, // 17: media.v1.MediaService.UploadFileApi:output_type -> media.v1.UploadFileApiResponse
	18, // 18: media.v1.MediaService.ObjectUploadConfirmation:output_type -> media.v1.ObjectUploadConfirmationResponse
	19, // 19: media.v1.MediaService.GetDashboard:output_type -> media.v1.GetDashboardResponse
	20, // 20: media.v1.MediaService.GetAssets:output_type -> media.v1.GetAssetsResponse
	21, // 21: media.v1.MediaService.GetAllFolders:output_type -> media.v1.GetAllFoldersResponse
	22, // 22: media.v1.MediaService.GetAllCollections:output_type -> media.v1.GetAllCollectionsResponse
	23, // 23: media.v1.MediaService.GetAssetsInFolder:output_type -> media.v1.GetAssetsInFolderResponse
	24, // 24: media.v1.MediaService.GetAssetsInCollection:output_type -> media.v1.GetAssetsInCollectionResponse
	25, // 25: media.v1.MediaService.CreateNewFolder:output_type -> media.v1.CreateNewFolderResponse
	26, // 26: media.v1.MediaService.CreateNewCollection:output_type -> media.v1.CreateNewCollectionResponse
	27, // 27: media.v1.MediaService.GetAssetsPage:output_type -> media.v1.GetAssetsPageResponse
