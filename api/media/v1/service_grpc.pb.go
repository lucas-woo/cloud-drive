...
const (
	...
	MediaService_GetAssetsPage_FullMethodName            = "/media.v1.MediaService/GetAssetsPage"
)
...
type MediaServiceClient interface {
	...
	GetAssetsPage(ctx context.Context, in *GetAssetsPageRequest, opts ...grpc.CallOption) (*GetAssetsPageResponse, error)
}
...
func (c *mediaServiceClient) GetAssetsPage(ctx context.Context, in *GetAssetsPageRequest, opts ...grpc.CallOption) (*GetAssetsPageResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetAssetsPageResponse)
	err := c.cc.Invoke(ctx, MediaService_GetAssetsPage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MediaServiceServer interface {
	...
	GetAssetsPage(context.Context, *GetAssetsPageRequest) (*GetAssetsPageResponse, error)
...
func (UnimplementedMediaServiceServer) GetAssetsPage(context.Context, *GetAssetsPageRequest) (*GetAssetsPageResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetAssetsPage not implemented")
}
...
func _MediaService_GetAssetsPage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetAssetsPageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MediaServiceServer).GetAssetsPage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MediaService_GetAssetsPage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MediaServiceServer).GetAssetsPage(ctx, req.(*GetAssetsPageRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MediaService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetAssetsPage",
			Handler:    _MediaService_GetAssetsPage_Handler,
		},
	},
